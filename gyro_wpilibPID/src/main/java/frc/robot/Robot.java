...
public class Robot extends TimedRobot {
  ...
  m_oi.myPID.setOutputRange(-.7, .7);
  m_oi.myPID.setAbsoluteTolerance(2);
  m_oi.myPID.setSetpoint(0);
  m_oi.myPID.enable();
}
  ...
  m_oi.myPID.setPID(m_oi.kp.getDouble(0), m_oi.ki.getDouble(0), m_oi.kd.getDouble(0), 0);
  m_oi.myPID.setSetpoint(m_oi.setpoint.getDouble(0));
  ...
  public void teleopPeriodic() {
    ...
    /* check deadband */
    if(m_oi.m_leftStick.getRawAxis(4) > 0.2 || m_oi.m_leftStick.getRawAxis(4) < -0.2){
